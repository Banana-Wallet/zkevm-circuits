...
mod application {
    ...
    use rand::RngCore;
    use snark_verifier::loader::halo2::halo2_ecc::halo2_base::halo2_proofs::arithmetic::Field;
...
mod aggregation {
    ...
    use snark_verifier::loader::halo2::halo2_ecc::{self as halo2_ecc, fields::fp::FpStrategy};
    use snark_verifier::loader::halo2::halo2_ecc::{ecc::EccChip, halo2_base::{Context, ContextParams}};
    use snark_verifier::loader::halo2::halo2_ecc::halo2_base as halo2_base; 
    use itertools::Itertools;
    use rand::rngs::OsRng;
    use snark_verifier::{
